...
```{r, echo=FALSE, out.width = "80%", fig.cap="Cianobactérias", fig.pos = 'H', fig.align = 'center', label = "fig1"}
knitr::include_graphics("G:/Meu Drive/estatistica/mlg/glm/trab_final/imagens/cianobacteria.png")
