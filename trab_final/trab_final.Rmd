...
A figura \ref{fig:envelope}, apresenta o envelope simulado com $\alpha = 5\%$.
...
A figura \ref{fig:cook}, apresenta a distância de cook.
...
\newpage
A figura \ref{fig:residuos} apresenta os gráficos para os resíduos.
